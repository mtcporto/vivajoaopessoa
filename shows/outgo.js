function parsePortugueseDate(dateStr) {
    // Normaliza a string: remove quebras de linha e múltiplos espaços
    dateStr = dateStr.replace(/\s+/g, ' ').trim();
    // Exemplo: "Sábado, 8 de fevereiro" ou "8 de fevereiro"
    // Ajustando a regex para incluir letras acentuadas: À-ÖØ-öø-ÿ
    const regex = /(\d{1,2})\s+de\s+([\wÀ-ÖØ-öø-ÿ]+)/i;
